...
![Рисунок 1: Диаграмма классов реализации](./Assets/Classv2.png)
...
Нам сначала пришлось бы определить каждую компанию с помощью функции. Затем нам пришлось бы добавить условия if... else... в класс ShippingCalculator и вычислить их. Ниже показан код, в котором шаблон Strategy  не применяется.

...
![cdiagram](./Assets/Screenshot%202026-03-18%20004309.png)

<small>Рисунок 1: Упрощенная диаграмма классов метода c применением приспособлецa. </small>
...
В данном случае Texture и его наследующие его классы являются объектами класса Flyweight, а TextureFactory — это flyweights factory.
...
<small>Рисунок 3: Игра без Flyweights.</small>
...
| Особенность | Без Flyweights | С Flyweights |
| :--- | :--- | :--- |
...
| **Размер объекта (ОЗУ)** | **Высокая.** Объект содержит полную структуру текстуры. | **Низкая.** Объект содержит только 64-битный указатель. |
